...
def floatinB10(flag,ii,tovPrice,er,Lastsize,Lastprice,Aprice,Asize,Bprice,Bsize):
    if flag==1:
        ...
        if  abs(er/Lastsize[ii])<10:
            ...
            if Lastsize[ii]-round(3*abs(er/60))<0:
                flag3 = 1
                pass
            #print(Lastsize[ii],abs(er/60),er,Asize[ii-1])
            if newp1==Aprice[ii-1]:
                return [[Lastprice[ii],[Lastsize[ii]-round(3*abs(er/60)),0]],[newp1,[round(abs(er/60))+Asize[ii-1],0]],[newp2,[round(abs(er/60)),0]],[newp3,[round(abs(er/60)),0]]]

            elif newp2==Aprice[ii-1]:
                return [[Lastprice[ii],[Lastsize[ii]-round(3*abs(er/60)),0]],[newp1,[round(abs(er/60)),0]],[newp2,[round(abs(er/60))+Asize[ii-1],0]],[newp3,[round(abs(er/60)),0]]]

            elif newp3==Aprice[ii-1]:
                return [[Lastprice[ii],[Lastsize[ii]-round(3*abs(er/60)),0]],[newp1,[round(abs(er/60)),0]],[newp2,[round(abs(er/60)),0]],[newp3,[round(abs(er/60))+Asize[ii-1],0]]]

            else:
                return [[Lastprice[ii],[Lastsize[ii]-round(3*abs(er/60)),0]],[newp1,[round(abs(er/60)),0]],[newp2,[round(abs(er/60)),0]],[newp3,[round(abs(er/60)),0]],[Aprice[ii-1],[Asize[ii-1],0]]]
        if flag3==1:
            newp1=Lastprice[ii]-10*(er/abs(er))
            newp2=Lastprice[ii]-20*(er/abs(er))
            newp3=Lastprice[ii]-30*(er/abs(er))
    ...
    if flag==1:
        ...
        if  abs(er/Lastsize[ii])<10:
            ...
            if newp1==Bprice[ii-1]:
                return [[Lastprice[ii],[0,Lastsize[ii]-round(3*abs(er/60))]],[newp1,[0,round(abs(er/60))+Bsize[ii-1]]],[newp2,[0,round(abs(er/60))]],[newp3,[0,round(abs(er/60))]]]

            elif newp2==Bprice[ii-1]:
                return [[Lastprice[ii],[0,Lastsize[ii]-round(3*abs(er/60))]],[newp1,[0,round(abs(er/60))]],[newp2,[0,round(abs(er/60))+Bsize[ii-1]]],[newp3,[0,round(abs(er/60))]]]

            elif newp3==Bprice[ii-1]:
                return [[Lastprice[ii],[0,Lastsize[ii]-round(3*abs(er/60))]],[newp1,[0,round(abs(er/60))]],[newp2,[0,round(abs(er/60))]],[newp3,[0,round(abs(er/60))+Bsize[ii-1]]]]

            else:
                return [[Lastprice[ii],[0,Lastsize[ii]-round(3*abs(er/60))]],[newp1,[0,round(abs(er/60))]],[newp2,[0,round(abs(er/60))]],[newp3,[0,round(abs(er/60))]],[Bprice[ii-1],[0,Bsize[ii-1]]]]
        if flag3==1:
            newp1=Lastprice[ii]-10*(er/abs(er))
            newp2=Lastprice[ii]-20*(er/abs(er))
            newp3=Lastprice[ii]-30*(er/abs(er))
